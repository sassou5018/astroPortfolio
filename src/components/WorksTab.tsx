...
const works = [
    ...
    {articles: [
      ...
      {title: 'Youtube and obscure Japanese EPs', description: '', image: 'https://iili.io/HnmJPSa.md.png', link:'https://blog.benahmed.tech/posts/youtube-and-obscure-japanese-eps/', tag: 'Culture'},
      ...
      {title: "Takashi Murakami", description:"", image:'https://atwoodmagazine.com/wp-content/uploads/2018/06/uaNIo6X-1050x700.jpg', link:'https://blog.benahmed.tech/posts/takashi-murakami/', tag: 'Culture'},
      {title: "Retrospect on anime classics", description:"", image:'https://c.tenor.com/7VhAawmeCT4AAAAC/perfect-blue-anime.gif', link:'https://blog.benahmed.tech/posts/retrospect-on-anime-classics/', tag: 'Culture'},
      {title:"Lofi Hiphop and its Japanese influences", description:"", image:'https://thumbs.gfycat.com/AgedMiniatureBoto-max-1mb.gif', link:'https://blog.benahmed.tech/posts/lofi-hiphop-and-its-japanese-influences/', tag: 'Culture'},
    ]},
    {videos: [
